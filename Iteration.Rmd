...
We need to import the html, and then extract 
```{r}
...
Define a function that fits the regression i want.
...
```{r}
weather_lm = lm(weather_nest[["data"]][[1]])
```
